...
values, 'ON' and 'OFF' (by convention, enum values are typically fully capitalized). Enums are preferable to booleans because they can represent a number of states (as
