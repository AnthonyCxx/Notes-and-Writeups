...
in scientific notation. Neat as this all is, format specifiers are usually just used for [string formatting/interpolation](https://en.wikipedia.org/wiki/Printf_format_string).
