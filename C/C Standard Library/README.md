...
| [\<errno.h\>](https://en.wikipedia.org/wiki/Errno.h) | contains a macro [_extern int errno_](https://www.tutorialspoint.com/c_standard_library/c_macro_errno.htm) used for 
error status codes |
