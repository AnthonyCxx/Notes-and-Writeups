...
| File | Function | 
| ---- | -------- |
| [Pointers.md](https://github.com/EthanC2/Notes-and-Writeups/blob/main/C/Memory%20Mangagement/Pointers.md) | a datatype for manually tracking dynamically-allocated memory |
