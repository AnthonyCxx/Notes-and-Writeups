...
When passing value types as a parameter, the variable itself is not only passed, only the value stored in it. Any changes to the copied value will not affect
