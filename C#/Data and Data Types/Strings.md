...
In C#, the _char_ type is 2-bytes wide (16-bits), which means that strings implicitly support UTF-16 (this is in contrast to C++, in which chars only support ASCII and wide strings must 
