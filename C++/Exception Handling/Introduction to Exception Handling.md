...
The ellipsis operator, ..., can be used as a general catch-all. Think of it as Python's _except Exception_ or Java's [_Throwable_](https://www.geeksforgeeks.org/throwable-class-in-java-with-examples/)
