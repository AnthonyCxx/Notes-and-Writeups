...
fails. If there were no catch _try_/_catch_ block, then the program would have crashed with the message "terminate called after throwing an instance of 'std::bad_alloc'.
