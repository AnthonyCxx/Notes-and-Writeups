...
want to write out `coordinates.multiply(Othercoordinates.negate())` when you could write `coordinates * -OtherCoordinates` instead (looking at you, Java programmers)? Obivously, there is a question of clarity, 
