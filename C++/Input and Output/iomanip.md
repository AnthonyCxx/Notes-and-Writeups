...
decimal part as specified by the _precision_ field and with no exponent part." The _fixed_ format is also useful for preventing the implicit representation of floats in 
scientific notation.
