...
is left to be deduced (like in templated functions (`T&&`) or `auto&& var`) beause it depends on what the reference is initialized with. This is because of the rulesets
for type deductions, which are explained [here](https://www.youtube.com/watch?v=wQxj20X-tIU).
