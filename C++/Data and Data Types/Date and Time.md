...
The _duration_ class is a template that can be used to create custom units of time. In the talk, Mr. Hinnant uses the example of a game developer trying to measure
